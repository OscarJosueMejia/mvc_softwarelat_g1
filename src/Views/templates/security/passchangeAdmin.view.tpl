            ...
            <div style="width:30%">
                ...
                <form action="index.php?page=sec_passwordchange" method="post"
                    ...
                    <div class="main-button m-auto text-center">
                        <button class="btn btn-warning" id="btnCambiar" name="btnCambiar" type="submit">Cambiar Contraseña</button>
                        &nbsp;
                        &nbsp;
                        <button class="btn btn-danger" id="btnCancelar" name="btnCancelar" type="button">Cancelar</button>
                        &nbsp;
                    </div>
                    <br>
                    <br />
